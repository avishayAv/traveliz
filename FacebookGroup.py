...
class FacebookGroups:
    def __init__(self):
        ...
        self.groups = [FacebookGroup("סאבלט בישראל sublet in israel", "461136684495769", False),
                       ...
                       FacebookGroup("סאבלט ביפו", "321832879616768", True),
                       ...
                       FacebookGroup("דירות ריקות בין חברים בחיפה - סאבלט", "553686734681522", True),
                       FacebookGroup("סבלטים ודירות לתקופות קצרות בתל אביב", "456319007826317", True),
                       ...
                       FacebookGroup('סאבלטים וסופ"ש ♣ נחלאות רחביה והסביבה', "812498172191403", True),
                       ...
                       FacebookGroup("דירות airbnb מרוהטות לסאבלט ונופש.Меблированные квартиры для аренды и отдых", "512739526298733", True)
        ]

class FacebookGroup:
    def __init__(self, group_name, group_id, is_public):
